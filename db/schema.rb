...
ActiveRecord::Schema.define(:version => 20121119101515) do
  ...
  create_table "funs_tags", :id => false, :force => true do |t|
    t.integer "fun_id"
    t.integer "tag_id"
  end

  add_index "funs_tags", ["fun_id"], :name => "index_funs_tags_on_fun_id"
  add_index "funs_tags", ["tag_id"], :name => "index_funs_tags_on_tag_id"

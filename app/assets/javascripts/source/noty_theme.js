			...
			borderFix: function() {
				if (this.options.dismissQueue) {
					...
					switch (this.options.layout.name) {
						case 'top':
							$(selector).css({borderRadius: '0px 0px 0px 0px'}); break;
...
//				background: "url('data:image/png;base64,') repeat-x scroll left top #fff"
				background: "url('/assets/noty_bg.png') repeat-x scroll left top #fff"
			});
			...
			switch (this.options.type) {
				...
				case 'success':
					this.$bar.css({backgroundColor: '#7EC553', borderColor: '#44871f', color: '#f8f8f8'});
